...
import { LifeBuoy, PlusCircle, Clock, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link 
          href="/suporte/novo" 
          className="bg-gold-600 hover:bg-gold-700 text-white font-semibold py-2 px-4 rounded-xl flex items-center gap-2 transition-all shadow-lg shadow-gold-500/20"
        >
        ...
        <div className="grid gap-4">
          {tickets.map(ticket => (
            <Link key={ticket.id} href={`/suporte/${ticket.id}`} className="block">
              <div className="bg-slate-900 border border-slate-800 hover:border-slate-700 rounded-2xl p-5 transition-all flex items-center justify-between group">
